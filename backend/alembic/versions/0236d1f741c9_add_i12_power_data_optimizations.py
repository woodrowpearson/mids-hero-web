...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_power_name_powerset", "powers", ["name", "powerset_id"], unique=False
    )

    op.create_index(
        "idx_power_internal_name", "powers", ["internal_name"], unique=False
    )
    ...
    op.create_index("idx_import_logs_date", "import_logs", ["started_at"], unique=False)
