...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_archetype_groups", "archetypes", ["primary_group", "secondary_group"]
    )
    ...
    op.create_table(
        ...
        sa.Column("description", sa.Text()),
        sa.Column(
            "archetype_id", sa.Integer(), sa.ForeignKey("archetypes.id"), nullable=False
        ),
    ...
    op.create_unique_constraint(
        "uq_powerset_archetype_type",
        "powersets",
        ["name", "archetype_id", "powerset_type"],
    )
    ...
    op.create_table(
        ...
        sa.Column("description", sa.Text()),
        sa.Column(
            "powerset_id", sa.Integer(), sa.ForeignKey("powersets.id"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True, index=True),
        sa.Column(
            "set_id", sa.Integer(), sa.ForeignKey("enhancement_sets.id"), nullable=False
        ),
    ...
    op.create_index(
        "idx_compat_type", "power_enhancement_compatibility", ["enhancement_type"]
    )
    op.create_unique_constraint(
        "uq_power_enhancement_type",
        "power_enhancement_compatibility",
        ["power_id", "enhancement_type"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "primary_powerset_id",
            sa.Integer(),
            sa.ForeignKey("powersets.id"),
            nullable=False,
        ),
        sa.Column(
            "secondary_powerset_id",
            sa.Integer(),
            sa.ForeignKey("powersets.id"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "build_power_id",
            sa.Integer(),
            sa.ForeignKey("build_powers.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "enhancement_id",
            sa.Integer(),
            sa.ForeignKey("enhancements.id"),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_build_enh_enhancement", "build_enhancements", ["enhancement_id"]
    )
