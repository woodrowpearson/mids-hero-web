...
class EffectType(Enum):
    ...
    MODIFY_ATTRIB = 84
    EXECUTE_POWER = 85
    # Debuff Resistance Types (extensions for specific resistances)
    DEFENSE_DEBUFF_RESISTANCE = 86
    ENDURANCE_DEBUFF_RESISTANCE = 87
    PERCEPTION_DEBUFF_RESISTANCE = 88
    RECHARGE_DEBUFF_RESISTANCE = 89
    RECOVERY_DEBUFF_RESISTANCE = 90
    REGENERATION_DEBUFF_RESISTANCE = 91
    TOHIT_DEBUFF_RESISTANCE = 92
