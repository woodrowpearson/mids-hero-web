...
from app.mhd_parser.archetype_parser import parse_archetype, Archetype
...
class TestArchetypeParser:
    ...
    def test_parse_minimal_archetype(self):
        ...
        assert archetype.playable == True
