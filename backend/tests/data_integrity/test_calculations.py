...
from app.models import Archetype, Power, Enhancement, EnhancementSet, SetBonus
...
class TestSetBonusCalculations:
    ...
    def test_set_bonus_stacking(self, db: Session):
        ...
        bonuses = db.query(
            EnhancementSetBonus.bonus_type,
            EnhancementSetBonus.attribute,
            EnhancementSetBonus.magnitude
        ).distinct().all()
