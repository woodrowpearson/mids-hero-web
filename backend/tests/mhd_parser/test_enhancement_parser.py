...
from app.mhd_parser.enhancement_parser import (
    parse_enhancement, parse_enhancement_set, parse_s_effect,
    Enhancement, EnhancementSet, SEffect, EffectMode
)
...
class TestEnhancementParser:
    ...
    def test_parse_minimal_enhancement(self):
        ...
        assert enhancement.unique == False
        ...
        assert enhancement.superior == False
        assert enhancement.is_proc == False
        assert enhancement.is_scalable == True
    ...
    def test_parse_enhancement_with_class_restrictions(self):
        ...
        assert enhancement.unique == True
        ...
        assert enhancement.is_scalable == False
