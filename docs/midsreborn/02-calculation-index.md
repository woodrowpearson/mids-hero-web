...
| # | Specification | Status | Priority | Complexity | Notes |
|---|---------------|--------|----------|------------|-------|
| 10 | [enhancement-schedules.md](calculations/10-enhancement-schedules.md) | 🔴 Not Started | Critical | Complex | ED curves (Schedule A/B/C/D) - CRITICAL |
...
| 12 | [enhancement-io-procs.md](calculations/12-enhancement-io-procs.md) | 🔴 Not Started | High | Complex | Damage/heal/endurance procs |
...
| 15 | [enhancement-frankenslotting.md](calculations/15-enhancement-frankenslotting.md) | 🔴 Not Started | Medium | Simple | Mixed set slotting strategies |

**Enhancement System Summary**: ED curves (spec 10) are absolutely critical. Set bonuses (spec 13) are core to build planning.
